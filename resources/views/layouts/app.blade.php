                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('users.edit', Auth::user()) }}" onclick="event.preventDefault(); document.getElementById('user-form').submit(); ">{{ __('Profile') }}</a>
                                    <form id="user-form" action="{{ route('users.edit', Auth::user()) }}" method="GET" class="d-none">@csrf</form>
